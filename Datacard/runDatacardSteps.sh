...
INPUT_MAP="2022preEE=/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_13Dec2025_noDeco/workspaces/2022preEE/ws_signal,2022postEE=/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_13Dec2025_noDeco/workspaces/2022postEE/ws_signal,2023preBPix=/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_13Dec2025_noDeco/workspaces/2023preBPix/ws_signal,2023postBPix=/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_13Dec2025_noDeco/workspaces/2023postBPix/ws_signal"
...
RUN_MODES=${RUN_MODES:-"CPODD KTM1KTT0 KT0P7KTT0P7 KT0P7KTTM0P7 KT0KTTM1 KT0KTT0"}
# RUN_MODES="CPODD"
# RUN_MODES="KTM1KTT0"
...
for LABEL in ${RUN_MODES}; do
    case "$LABEL" in
        SM)           PROCS="$PROCS_SM"           EXT="tth_th_analysis_noDeco" ;;
        CPODD)        PROCS="$PROCS_CPODD"        EXT="tth_th_analysis_noDeco_CPodd" ;;
        KTM1KTT0)     PROCS="$PROCS_KTM1KTT0"     EXT="tth_th_analysis_noDeco_Ktm1Ktt0" ;;
        KT0P7KTT0P7)  PROCS="$PROCS_KT0P7KTT0P7"  EXT="tth_th_analysis_noDeco_Kt0p7Ktt0p7" ;;
        KT0P7KTTM0P7) PROCS="$PROCS_KT0P7KTTM0P7" EXT="tth_th_analysis_noDeco_Kt0p7Kttm0p7" ;;
        KT0KTTM1)     PROCS="$PROCS_KT0KTTM1"     EXT="tth_th_analysis_noDeco_Kt0Kttm1" ;;
        KT0KTT0)      PROCS="$PROCS_KT0KTT0"      EXT="tth_th_analysis_noDeco_Kt0Ktt0" ;;
    esac
    ...
    python3 makeDatacard.py --years 2022preEE,2022postEE,2023preBPix,2023postBPix --ext ${EXT} --prune --pruneThreshold 0.001 --doTrueYield --analysis tth_th_analysis_noDeco --skipCOWCorr --doSystematics # --doMCStatUncertainty
