...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_13Dec2025_noDeco/workspaces/2023preBPix/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_noDeco_2023preBPix', # output directory extension
