...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_17Dec2025_withPenalty/workspaces/2023postBPix/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_2023postBPix', # output directory extension
