...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_14Jan2026_CP_penalty_10/workspaces_fiducial/2022preEE/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_fiducial_noDeco_SM_rates_2022preEE', # output directory extension
