...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_24Jan2026_CP_penalty_30/workspaces_fiducial/2023preBPix/ws_signal', # dir storing flashgg workspaces
