...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_06Feb2026_noDeco/workspaces_fiducial/2023preBPix/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_fiducial_noDeco_2023preBPix', # output directory extension
