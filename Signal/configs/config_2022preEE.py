...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits_17Dec2025_withPenalty/workspaces/2022preEE/ws_signal', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis_2022preEE', # output directory extension
