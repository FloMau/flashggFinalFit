...
signalScriptCfg = {
  ...
  # Setup
  'inputWSDir':'/net/data_cms3a-1/mausolf/HttCPAnalysis/finalFitPreparation/outputForFinalFits/workspaces/ws_tHqLep_out', # dir storing flashgg workspaces
  ...
  'ext':'tth_th_analysis', # output directory extension
